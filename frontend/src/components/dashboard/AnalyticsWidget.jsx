      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="ml-2">
              <svg width="70" height="70" viewBox="0 0 57 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path 
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="ml-2">
              <svg width="70" height="70" viewBox="0 0 64 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path 
