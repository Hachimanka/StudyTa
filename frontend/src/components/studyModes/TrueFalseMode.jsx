          ...
          <aside className="lg:col-span-3">
            <div className={`border border-[#6F422B] ${darkMode ? 'bg-[#2e2119]' : 'bg-[#F3DAC6]'} rounded-xl p-6 shadow-lg h-[500px]`}>
              ...
              <div className="space-y-4">
                ...
                <button onClick={() => navigate('/TrueFalseMode')} className={`w-full flex items-center space-x-4 p-3 rounded-lg border-2 ${darkMode ? 'bg-[#2e2119] border-[#8D5A3F]' : 'bg-[#F3DAC6] border-[#6F422B]'} shadow-lg`}>
              ...
              <div className="mt-auto">
                <div className="max-w-4xl mx-auto">
                  <div className="grid grid-cols-3 gap-8 items-center">
                    <button className={`py-3 rounded-full font-bold text-lg border-3 ${
                      darkMode 
