...
// Verify email and current password before allowing password change
export async function verifyCurrentPassword(req, res) {
  try {
...
export default { getProfile, updateProfile, verifyCurrentPassword, changePassword };
